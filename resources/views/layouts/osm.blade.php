...
<head>
    ...
    <title>Geekr OSM | @yield('page')</title>
    ...
    <link href="{{ asset('css/geekr.css') }}" rel="stylesheet">
    <!-- <link href="{{ asset('css/geekr-dark.css') }}" rel="stylesheet"> -->
</head>
  <body>
    <div id="app">
      <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm border-bottom">
        <div class="container">
          <a class="mt-4 mb-3" href="{{ route('employee-dashboard') }}" style="color: #000">Geekr OSM</a>
