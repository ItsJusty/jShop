        ...
        <div class="col-md-8">
            <div class="card">
              <div class="card-title text-center pt-4">
                <h5>{{ __('Je kan meer met een Geekr account!') }}</h5>
              </div>
              <hr/>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-geekr col-12">
                                    {{ __('Registreer') }}
                                </button>
                            </div>
                            <div class="col-md-6 offset-md-4 text-center pt-3">
                              <a class="col-12" href="{{ route('login') }}">Al een account? Log in!</a>
                            </div>
                        </div>
                    </form>
                </div>
