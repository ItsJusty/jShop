    ...
    <div class="row d-flex justify-content-center">
        <div class="col text-center">
            @if($paid == true)
                <div class="card shadow-lg">
                  ...
                  <div class="card-body">
                    ...
                    <a href="{{route('order-details', session('last_created_order_id'))}}" class="btn btn-geekr">{{__('cart.show_order_details')}}</a>
                  </div>
            ...
            @else
                ...
                <a class="btn btn-geekr" href="{{ action("PaymentController@preparePayment") }}">{{__('cart.order_click_to_pay')}}</a>
            @endif
